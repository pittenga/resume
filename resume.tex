...
\begin{document}
  ...
  \begin{experience}{Jul 2016 - Pres}{GE Aviation - Cincinnati, OH}{Accelerated Leadership Program - XLP}{ge.png}
    \task{XLP is GE’s accelerated leadership program, developing global leaders who solve tough challenges to maximize customer value.}
    \task{Designed for rising leaders, XLP builds on domain expertise through big stretch roles, high-impact business projects tied to the company’s strategy, transformational learning experiences, and a powerful network that spans the company’s major businesses and functional disciplines.}
    \task{Each XLP participant has an individual development plan and receives intensive coaching from GE’s most accomplished senior leaders.}
