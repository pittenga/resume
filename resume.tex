...
\begin{document}
  ...
  \begin{skills}
    Software: & Java, C/C++, Ada, Python, Markup Languages, Assembly, Linux BASH scripting \\
  \end{skills}
  \begin{skills}
    Tools: & Unix Tools (grep, gcc, sed, diff, etc.), git, svn, Eclipse, \LaTeX, VirtualBox/vmware, Visual Studio, Microsoft Tool Suite \\
  \end{skills}
  \begin{skills}
